...
public:
    ...
    // getter
    cv::Mat getEdge();
    cv::Mat getEdgeWoWeak();
    cv::Mat getOrientEdgeEstimation();
    cv::Mat getThinnedEdge();
    // For estimated optimal orientation map
    cv::Mat getEstiOptimalOrient();
    cv::Mat getColoredEstiOptimalOrient();
    cv::Mat getColoredEstiOptimalOrientGrid();
...
//private:
    ...
    cv::Mat edgeWoWeak;
    cv::Mat orientEdgeEstimation;
    cv::Mat estiOptimalOrient;
    cv::Mat thinnedEdge;
    void discardWeakEdge();
    void thinEdge();
};
